...
public class Schema {
    ...
    public static final String UPDATE_COMPANY =
            "UPDATE " + TABLE_NAME_COMPANY
                    + " SET " + COL_NAME + "=?," + COL_IMAGE_URL +
                    "=? WHERE " + COL_ID + "=?";

    public static final String SELECT_COMPANY_COUPONS =
    ...
    public static final String SELECT_COUPON_BY_TITLE =
            "SELECT * FROM " + TABLE_NAME_COUPON
                    + " WHERE " + COL_TITLE + "=?";

    /* COUPON */
    public static final String DELETE_COUPON =
            "DELETE FROM " + TABLE_NAME_COUPON + " WHERE " + COL_ID + "=?";

    /* STORED PROCEDURES */
    public static final String GENERATE_PROC_DELETE_COUPON =
            DROP_IF + " `delete_coupon`; " +
                    "CREATE PROCEDURE `delete_coupon`(IN COU_ID INT)" +
                    "BEGIN " +
                    "DELETE FROM " + TABLE_NAME_COUPON + " WHERE " + COL_ID + "=COU_ID; " +
                    "END";

    public static final String GENERATE_PROC_USER_LOGIN =
            DROP_IF + "`user_login`; " +
    ...
    public static final String GENERATE_PROC_GET_ALL_COMPANIES =
            DROP_IF + " `get_companies`; " +
                    "CREATE PROCEDURE `get_companies`() " +
                    "BEGIN " +
                    " SELECT * FROM " + TABLE_NAME_COMPANY + "; " +
                    "END";

    public static final String GENERATE_PROC_GET_ALL_COMPANIES_AND_COUPONS =
            DROP_IF + " `get_companies_and_coupons`; " +
